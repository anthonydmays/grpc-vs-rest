...
export const ContactsService = new ServiceType(
  ...
  [
    {
      name: 'ListContacts',
      options: { 'google.api.http': { get: '/v1/contacts' } },
      I: ListContactsRequest,
      O: ListContactsResponse,
    },
    {
      name: 'GetContact',
      options: { 'google.api.http': { get: '/v1/contacts/{id}' } },
      I: GetContactRequest,
    ...
    },
    {
      name: 'UpdateContact',
      options: {
        'google.api.http': { put: '/v1/contacts/{id}', body: 'contact' },
      },
    ...
    {
      name: 'DeleteContact',
      options: { 'google.api.http': { delete: '/v1/contacts/{id}' } },
      I: DeleteContactRequest,
      O: Empty,
    },
    {
      name: 'CreateContact',
      options: { 'google.api.http': { post: '/v1/contacts', body: 'contact' } },
