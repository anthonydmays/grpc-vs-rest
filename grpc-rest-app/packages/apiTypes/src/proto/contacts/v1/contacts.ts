...
export interface UpdateContactRequest {
    ...
    id: string;
    /**
     * @generated from protobuf field: proto.contacts.v1.Contact contact = 2;
     */
    contact?: Contact;
}
/**
...
class ListContactsResponse$Type extends MessageType<ListContactsResponse> {
    ...
    create(value?: PartialMessage<ListContactsResponse>): ListContactsResponse {
        const message = { contacts: [], pageSize: 0, pageNumber: 0, orderBy: "", totalCount: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class GetContactRequest$Type extends MessageType<GetContactRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetContactRequest): GetContactRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetContactRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string id = 1; */
        if (message.id !== "")
...
class GetContactResponse$Type extends MessageType<GetContactResponse> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetContactResponse): GetContactResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetContactResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class UpdateContactRequest$Type extends MessageType<UpdateContactRequest> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string id */ 1:
                    message.id = reader.string();
                    break;
                case /* proto.contacts.v1.Contact contact */ 2:
                    message.contact = Contact.internalBinaryRead(reader, reader.uint32(), options, message.contact);
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: UpdateContactRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.id !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.id);
        /* proto.contacts.v1.Contact contact = 2; */
        if (message.contact)
            Contact.internalBinaryWrite(message.contact, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
export const ContactsService = new ServiceType("proto.contacts.v1.ContactsService", [
    { name: "ListContacts", options: { "google.api.http": { get: "/v1/contacts" } }, I: ListContactsRequest, O: ListContactsResponse },
    { name: "GetContact", options: { "google.api.http": { get: "/v1/contacts/{id}" } }, I: GetContactRequest, O: GetContactResponse },
    { name: "UpdateContact", options: { "google.api.http": { put: "/v1/contacts/{id}", body: "contact" } }, I: UpdateContactRequest, O: UpdateContactResponse },
    { name: "DeleteContact", options: { "google.api.http": { delete: "/v1/contacts/{id}" } }, I: DeleteContactRequest, O: Empty },
    { name: "CreateContact", options: { "google.api.http": { post: "/v1/contacts", body: "contact" } }, I: CreateContactRequest, O: CreateContactResponse }
]);
