...
export interface IContactsServiceClient {
     ...
     */
    getContact(input: GetContactRequest, options?: RpcOptions): UnaryCall<GetContactRequest, GetContactResponse>;
    /**
     ...
     */
    deleteContact(input: DeleteContactRequest, options?: RpcOptions): UnaryCall<DeleteContactRequest, Empty>;
    /**
     * Creates a contact.
     *
...
export class ContactsServiceClient implements IContactsServiceClient, ServiceInfo {
    ...
    getContact(input: GetContactRequest, options?: RpcOptions): UnaryCall<GetContactRequest, GetContactResponse> {
        ...
        return stackIntercept<GetContactRequest, GetContactResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * Updates a contact with the provided information.
     *
    ...
    deleteContact(input: DeleteContactRequest, options?: RpcOptions): UnaryCall<DeleteContactRequest, Empty> {
        ...
        return stackIntercept<DeleteContactRequest, Empty>("unary", this._transport, method, opt, input);
    }
    /**
     * Creates a contact.
     *
