 ...
 *
 * HTTP | gRPC -----|----- `GET /v1/messages/123456` | `GetMessage(name:
 * "messages/123456")`
 *
 ...
 *
 * HTTP | gRPC -----|----- `GET /v1/messages/123456` | `GetMessage(message_id:
 ...
 *         name is the field path in the request message. A repeated field can
 *         be represented as multiple query parameters under the same name.
