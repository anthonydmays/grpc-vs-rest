...
export class GetContactResponse extends Message<GetContactResponse> {
  ...
  static equals(
    a: GetContactResponse | PlainMessage<GetContactResponse> | undefined,
    b: GetContactResponse | PlainMessage<GetContactResponse> | undefined
  ): boolean {
...
export class UpdateContactResponse extends Message<UpdateContactResponse> {
  ...
  static equals(
    a: UpdateContactResponse | PlainMessage<UpdateContactResponse> | undefined,
    b: UpdateContactResponse | PlainMessage<UpdateContactResponse> | undefined
  ): boolean {
